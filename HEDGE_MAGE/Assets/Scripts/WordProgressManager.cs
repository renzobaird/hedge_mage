...
//     {
//         if (currentWord == null || currentWord.Length == 0) return;
//         LetterManagerGO.Instance.SpawnLettersForWord(currentWord);
//     }

//     private void SetupUI()
//     {
//         if (letterSlotsParent == null) return;

//         foreach (Transform child in letterSlotsParent)
//         {
//             Destroy(child.gameObject);
//         }
...
//         {
//             GameObject newSlot = Instantiate(letterSlotPrefab, letterSlotsParent);
//             LetterSlot slot = newSlot.GetComponent<LetterSlot>();
//             if (slot != null)
//             {
//                 slot.SetLetter(letter, false); // default to uncollected
//                 letterSlots.Add(slot);
//             }
//         }
//     }
